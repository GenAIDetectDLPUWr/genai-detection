...
# gen_ai_detection documentation build
...
from gen_ai_detection import __version__ as release

# -- Project information -----------------------------------------------------

project = "gen_ai_detection"
author = "Kedro"
...
htmlhelp_basename = "gen_ai_detectiondoc"
...
latex_documents = [
    (
        master_doc,
        "gen_ai_detection.tex",
        "gen_ai_detection Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "gen_ai_detection",
        "Project gen_ai_detection codebase.",
        "Data-Science",
    )
]
